...
if (output) then
                ...
                if(ioparg == 1 .and. iopang == 1) write(30, 1440) barg(jarg), s1c(jarg), is1e(jarg), naccs(jarg)
                if(ioparg == 1 .and. iopang == 2) write(30, 1450) barg(jarg), s1c(jarg), is1e(jarg), s1dc(jarg), &
                        is1de(jarg), naccs(jarg), naccds(jarg)
